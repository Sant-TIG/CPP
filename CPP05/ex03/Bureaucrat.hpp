 ...
 * The class provides functionality to manage and validate the grade, to sign a form and it throws exceptions if the grade is out of bounds.
 */
class Bureaucrat {
	private:
