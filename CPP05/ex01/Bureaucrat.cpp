...
/*   Updated: 2023/09/11 15:05:39 by sperez-p         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signForm( Form &oneForm ) {
	try {
		...
		std::cout << _name << " signed " << oneForm.getName() << std::endl;
	} catch (const Form::GradeTooLowException &e) {
		std::cerr << _name << " couldn't sign " << oneForm.getName() << " because " << e.what() << std::endl;
	}
}
